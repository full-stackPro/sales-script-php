...
(function($, d, w) {
    ...
    $.fn.notebook.defaults = {
        ...
        mode: 'multiline',
        modifiers: ['bold', 'italic', 'underline', 'h1', 'h2', 'ol', 'ul', 'fontSize','fontFamily']
    };
