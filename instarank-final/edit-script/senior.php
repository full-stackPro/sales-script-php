...
<html>
  <head>
    ...
    <link rel="stylesheet" href="assets/css/senior-style.css" type="text/css">
  ...
  <body>
    ...
    <div class="wrapper editor fr-box fr-inline" role="application">
      <div class="fr-wrapper" dir="auto">
        <div class="fr-element fr-view" dir="auto" contenteditable="true" aria-disabled="false" spellcheck="true">
          ...
          <nav id="sidebar">
            ...
            <ul class="swapable list_sortable ui-sortable" id="excitement">
              ...
              <li class="inline-buttons ui-sortable-handle ui-sortable">
                <div class="ui-sortable-handle"><button class="buttons" value="verificationScript">VERIFICATION<span class="fa fa-minus-circle del"></span></button></div>
                <span class="fa fa-plus-circle ui-sortable-handle" data-popup-open="popup-1"></span>
              </li>
              <li class="inline-buttons ui-sortable-handle ui-sortable">
                <div class="ui-sortable-handle"><button class="buttons" value="premium1">PITCH<span class="fa fa-minus-circle del"></span></button></div>
                <span class="fa fa-plus-circle ui-sortable-handle" data-popup-open="popup-1"></span>
              </li>
              <li class="inline-buttons ui-sortable-handle ui-sortable">
                <div class="ui-sortable-handle"><button class="buttons" value="disclaimer">DISCLAIMER<span class="fa fa-minus-circle del"></span></button></div>
                <span class="fa fa-plus-circle ui-sortable-handle" data-popup-open="popup-1"></span>
              </li>
              <li class="inline-buttons ui-sortable-handle ui-sortable">
                <div class="ui-sortable-handle"><button class="buttons" value="outro">OUTRO<span class="fa fa-minus-circle del"></span></button></div>
                <span class="fa fa-plus-circle ui-sortable-handle" data-popup-open="popup-1"></span>
              </li>
            </ul>
            <ul class="list_sortable ui-sortable" id="urgency">
              ...
              <li class="inline-buttons ui-sortable-handle ui-sortable">
                <div class="ui-sortable-handle"><button class="buttons" value="plus1">"RE PITCH" (1)<span class="fa fa-minus-circle del"></span></button></div>
                <div class="ui-sortable-handle"><button class="buttons" value="plus2">(2)<span class="fa fa-minus-circle del"></span></button></div>
                <span class="fa fa-plus-circle ui-sortable-handle" data-popup-open="popup-1"></span>
              </li>
            </ul>
          </nav>
          ...
          <div id="content">
            <div id="topArea">
              <span class="section-bg-colors">&nbsp;</span> <span class="section-colors">&nbsp;</span>
              <div class="mainContent" id="verificationScript">Hi, my name is <strong>[FULL NAME]</strong> -- I’m a senior verification officer here at Bgin <strong><u>Online</u></strong>. Can I get your first and last name so I can verify the transfer? Ok Great, Hi, <strong>[NAME]</strong>, I do want to let you know, this call is being recorded for verification purposes. Okay? <strong>[HIT “RECORD” AFTER CUSTOMER AGREES]</strong><br>Ok (CLIENT NAME), again my name is (NAME) and we are recording for verification, now, I’m just going to quickly confirm the information I’ve received from <strong>[SALES AGENT]</strong> and set up your account, okay?<br>Okay, I have your <u>name</u> as it will appear on your ad as <strong>[NAME]</strong>.   —  Is that the same way it appears on your Card?<br>I have the best <u>phone number</u> for clients to reach you as <strong>[NUMBER]</strong>.<br>And I have your <u>preferred location</u> as <strong>[ZIP/CITY/COUNTY]</strong> in <strong>[STATE]</strong><br>And we’ll be linking your ad to your <u>personal website</u> at <strong>[READ WEB ADDRESS]</strong>, is that correct? (Go to the website and make sure it works!)<br>Most importantly for us, I need the best <u>email address</u> for your receipt - is that <strong>[SPELL OUT EMAIL ADDRESS]</strong>?<br>Now, I will also need the <u>3 digit code</u> on the back of your card (4 digits on front if card is AmEx)</div>
              <div class="mainContent" id="premium1">Great! Now, one thing I want to do real quick is go over the other packages we provide, because they’re not available to add after the first month, and you get a really great discount on them right now. You just let me know what you think afterward. Okay?<br>Perfect. Now, on that note, do you work strictly in <strong>(CITY)</strong> or do you target other areas as well?<br>[TALK to the client about multiple cities or areas, use this to tailor your pitch - get them thinking BIG! Remember that you can pitch multiple cities instead of "COUNTY Slots"]<br>Okay, great! Now, I don't know if <strong>(SALES REP NAME)</strong> explained how our company works, what we do is split each area into slots based on the number of buyers and sellers we’ve found there, so they don’t overlap. That way, our clients don’t compete with each other.<br>So that’s what <strong>(SALES REP NAME)</strong> sold you - a slot, with a guarantee of 2,000 views per month on websites all over the internet, by your market. But, I take it when <strong>(SALES REP NAME)</strong> called you, it was just for <strong>(CITY)</strong>, right?<br>Yeah, I figured, since they haven’t started calling on our COUNTY SLOTS yet. So, here’s what I’d suggest doing this first month, if you can pull it off: <strong>&nbsp;Start with our premium package.&nbsp;</strong><br>Here’s why I want you to do that: The COUNTY slots actually get EIGHT of those regular slots, for 16,000 total views, which means you’d completely DOMINATE <strong>(COUNTY)</strong> -- and you’d also block out your competitors, since this is “first come first served”! Plus, with this package, I’d also be able to add mobile for free, which means you’d show up on smart phones, tablets, I-pads --- all that stuff.<br>Also, with the premium, you’ll get your own dedicated marketing team. They're going to coordinate the details of your marketing efforts, make sure everything works great, and gladly answer any questions you might have. So, at the end of the month, what I’d have you do is call your team and go over each area. They’ll be able to rank your success by area, slot by slot, from 1st to 8th. That way you can make an educated decision every month about your best budget. You keep your best slots so you KNOW you'll get the best Return on your Investment!<br>And if you start as a premium, you stay a premium customer, so you can scale back up and down whenever you want. You can move down to the 139 next month and work your best area. Or even better, you decide you love the extra business, then you can keep this package and keep paying only $499/month, while anyone else would pay at least $1,500 for the same package!<br>But again, this package is only available to you your first month. After that, our slots will be gone, which means you won’t be able to dominate your area later.   So, I would highly recommend starting with the premium. $499.95 for EIGHT times the exposure, 16,000 views covering all of <strong>(COUNTY)</strong>. What do you think - can you pull this off for this first month?</div>
            ...
            <div id="answers-section">
              ...
              <div id="rebuttalArea">
                ...
                <p class="rebuttal" id="plus1">
                  <!-- NOTE TO SELF: *WAY* less salesy! --> Obviously, you want to be careful about where you spend your marketing dollars, but since marketing is about getting the best return on your investment, I just wanted to share something I’ve noticed from looking over monthly performance sheets.<br><br>First of all, you remember I mentioned that our premium package includes free mobile advertising as well. Well, I’ve found that about 75-80% of click-throughs actually come through mobile advertising with this package. Think about that for a second. How significant would your click-through boost be, if you were able to use mobile ads in the entire area of (COUNTIES)? You’d be able to connect with your potential clients on basically every device they own. Which means you'll stay "top of mind" WHEREVER they go!<br><br>[IF THEY REALLY CAN’T AFFORD 499, this is where you can pitch 239/339: “I do have a middle option, too. So I can STILL get you that mobile and a great discount - 8,000 views, that's FOUR slots, and we can still do your whole COUNTY, for $339...”]<br><br>And of course, you’ll get grandfathered in on that mobile hyper-targeting, plus you keep your own dedicated marketing team, no matter what you do after that first month. You stay a premium-level customer no matter what. So you can drop down to your best one or two or three slots, whatever’s working for you, and keep all the extras, too.<br><br>So this is the only time we can do that for you, and this is your chance to really push into your whole area, do your marketing right, and DOMINATE <strong>(COUNTY).</strong> So let's do this -- all I need is to read you a quick disclaimer and I can get you on your way…?
                </p>
                <p class="rebuttal" id="plus2">Of course, and I'm not trying to pressure you into anything. It's just my job to make sure this works for you, and obviously, the more views we can get you upfront, the better it's going to work, and the sooner you can get that closing and your Return on Investment. That's really all that matters.<br><br>Plus, the more views we can get you in the first month, the more data we'll have on how to market you as well as possible, in all of your future months. So it really works out way better for you in every way if you can "front-load" everything into your first month. Whatever you can afford, this is the right way to do it. [FIND THEIR PRICE POINT, remember it's all about their R.O.I. and getting there as soon as possible!]<br><br>(Ex: "Even if we step down to the $259 package, that's twice as many views, which means you get your money back twice as fast. We don't want you waiting on results, and money in your pocket means you stay with us. So let's get you there right away, and then you can scale up or down with your budget from there...")</p>
                <p class="rebuttal" id="plus3">I totally get it. I’m not trying to push you into anything, at all. Like I said, most customers DO choose to expand later. So, I get that you want to try it out and see, but if it does work at ALL, then it’s a positive return on your investment. That’s something you Always want to maximize. But this is a big sale right now and it will be over soon.<br><br>So that’s why I try to let my customers know that they can maximize our system, test multiple markets and most secure mobile devices for life for an extra hundred now and THEN you can do the basic at 139 for as long as you need to after the first month. You'll keep the mobile and you can move back up or expand to another city when you have more of a cash flow. But your market lives on their phones.<br><br>So let’s get you a second area now, and we can help you figure out which city is really the better bet at the end of the month - did you want (CITY 2)?</p>
              </div>
              <div id="introPrompt">
                <ul id="verification_btn">
                  <li class="inline-buttons ui-sortable"><button class="buttons ui-sortable-handle" value="verificationScript">VERIFICATION<span class="fa fa-minus-circle del"></span></button></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="fr-tooltip" style="left: -3000px; top: 163px; position: fixed;">Font Size</div>
  </body>
</html>
