          ...
          <div id="answers-section">
            ...
            <div id="rebuttalArea">
              <div id="default">((If Interrupted))
                <br>
                <br><em>No problem</em> - I can just quickly let you know how this works so at least you know your options, okay? [BACK TO PITCH!]
              </div>
              ...
              <div class="rebuttal" id="notAble" style="display: none;"><em>Okay, well...</em>
                ...
                <br>
                <br>[YES] Perfect! That's all we're talking about... [BACK TO PITCH!]
              </div>
              ...
              <div class="rebuttal" id="howMuch" style="display: none;"><em>Of course, I'll get right to that...</em>
                <br>Just let me really quickly tell you how this works - <em>It's real simple...</em>
              </div>
              <div class="rebuttal" id="value1" style="display: none;">You’ve used Facebook, right?
                ...
                <br>
                <br>Great! Now this service...  [TO PRICE]
              </div>
