...
<html>
  ...
  <body>
    ...
    <div class="wrapper editor jquery-notebook" data-jquery-notebook-id="1" editor-mode="multiline" editor-placeholder="Your text here..."  style="position: relative;">
      ...
      <div id="content">
        <div id="topArea">
          <h2 style="text-align: center;"><u>A</u>LWAYS!   <u>B</u>E!   <u>C</u>LOSING!</h2>
          --- WHAT IS THE <strong>BILLING ADDRESS</strong> FOR THE CARD YOU'D LIKE TO USE?
        ...
        <div id="answers-section">
          <div id="rebuttalArea">
            ...
            <div class="rebuttal" id="explanation1">You’ve used Facebook before, right?
              ...
              <br>
              <br>Great! Now we guarantee that we’ll do that 2,000 times every single month! All I need to get you started is the email you’d like us to send your receipt to when we’re done...
            </div>
            <div class="rebuttal" id="explanation2">Are you able to work with sellers?
              ...
              <br>
              <br>Now I have to get this going, but I have most of the information that I need - looks like the next thing I need to get is the best email address for us to send your receipt to when we're done...
            </div>
            <div class="rebuttal" id="explanation3">So I’m sure you’ve heard that your market lives on Facebook, right?
              ...
              <br>
              <br>And it’s month-to-month, with no contracts or commitments, so just give us one month to show you what kind of company we are, and I know you’ll want to stay with us as long as you’re in real estate. All I need to get you started is the billing address for the card you’d like to use…
            </div>
            ...
            <div class="rebuttal" id="competitor">That's no problem at all, what we do is a perfect way to supplement what you're already doing. I can quickly tell you how the service works so at least you know your options...
              <br>
              <br>(it's real simple how this works...)
            </div>
            ...
            <div class="rebuttal" id="trulia"><em>That's actually great to hear...</em>
              <br>Those are great companies, but they are completely different than what we do. They advertise on Facebook to get buyers and sellers to <strong>THEIR</strong> website. Then they place you in a directory along with hundreds of other agents or they sell you leads. But we work with you as an individual agent and your ad in front of real buyers and sellers on their own News Feeds, where we can link to a (Trulia/Zillow) profile if you'd like. So you can really stretch the money you're already spending by adding this direct route to your profile, and we won’t charge you any commission or extra fees. <strong>All I need to get you started is the billing address for the card you'd like to use. </strong>
            </div>
            <div class="rebuttal" id="aboutAds">We have a design department that makes custom ads for thousands of Realtors, for this exact service. We test those ads through millions of views to determine which ads work the best, so they’re always evolving to best serve you and your market. We only place them on active news feeds of active buyers and sellers in your area. They look great, work great, and give your prospects all the information they need. But if you do have special needs, you can contact your marketing team at any time to customize your ad as you need it.
              <br>
              <br>But we only work with real estate agents, so we know what works. That’s why we do this month to month, with no contract or cancellation fees, so that the burden’s on us to prove ourselves to you every single month. So let us bring you some business - All I need to get you started is the billing address for the card you’d like to use.
            </div>
